...
(cl:defmethod cl:initialize-instance :after ((m <Frame>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Frame)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name can_plugins-msg:<Frame> is deprecated: use can_plugins-msg:Frame instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Frame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader can_plugins-msg:header-val is deprecated.  Use can_plugins-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Frame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader can_plugins-msg:id-val is deprecated.  Use can_plugins-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'is_rtr-val :lambda-list '(m))
(cl:defmethod is_rtr-val ((m <Frame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader can_plugins-msg:is_rtr-val is deprecated.  Use can_plugins-msg:is_rtr instead.")
  (is_rtr m))

(cl:ensure-generic-function 'is_extended-val :lambda-list '(m))
(cl:defmethod is_extended-val ((m <Frame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader can_plugins-msg:is_extended-val is deprecated.  Use can_plugins-msg:is_extended instead.")
  (is_extended m))

(cl:ensure-generic-function 'is_error-val :lambda-list '(m))
(cl:defmethod is_error-val ((m <Frame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader can_plugins-msg:is_error-val is deprecated.  Use can_plugins-msg:is_error instead.")
  (is_error m))

(cl:ensure-generic-function 'dlc-val :lambda-list '(m))
(cl:defmethod dlc-val ((m <Frame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader can_plugins-msg:dlc-val is deprecated.  Use can_plugins-msg:dlc instead.")
  (dlc m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <Frame>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader can_plugins-msg:data-val is deprecated.  Use can_plugins-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Frame>)))
  ...
  (cl:format cl:nil "Header header~%uint32 id#CANのid~%bool is_rtr#リモートフレームかどうか？~%bool is_extended#idが拡張idかどうか？標準idとはトピックのようなもの、優先度がある。拡張idとは、11bitから11+18=29bitにしたもの。~%bool is_error#？~%uint8 dlc#Data length Code。~%uint8[8] data#8bit*8=8byte~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Frame)))
  "Returns full string definition for message of type 'Frame"
  (cl:format cl:nil "Header header~%uint32 id#CANのid~%bool is_rtr#リモートフレームかどうか？~%bool is_extended#idが拡張idかどうか？標準idとはトピックのようなもの、優先度がある。拡張idとは、11bitから11+18=29bitにしたもの。~%bool is_error#？~%uint8 dlc#Data length Code。~%uint8[8] data#8bit*8=8byte~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
